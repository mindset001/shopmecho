                ...
                <div class="container">
                    <form name="contentForm" enctype="multipart/form-data" method="post" action="">
                        <div class="ct-footer-pre text-center-lg">
                            <div class="inner">
                                <span>Join ShopMecho to receive updates, news &amp; events!</span>
                            </div>
                            <div class="inner">
                    ...
                    <div class="ct-footer-meta text-center-sm">
                        <div class="row">
                            <div class="col-sm-6 col-md-2">
                                <img alt="logo" src="../assets/logoo.png">
                            </div>
                            <div class="col-sm-6 col-md-3">
                                <address>
                                    <span>ShopMecho<br></span>2 Ahmed Musa Street,<br>
                                    Lakowe, Adeba Bus Stop, Lakowe, Lagos<br>
                                    <span>Phone: <a href="tel:5555555555">(555) 555-8899</a></span>
                                </address>
                            </div>
                            <div class="col-sm-6 col-md-2 ct-u-paddingTop10">
                                <a href="" target="_blank"><img alt="app store" src="../assets/google-play.png"></a>
                            </div>
                            <div class="col-sm-6 col-md-2 ct-u-paddingTop10">
                ...
                <div class="ct-footer-post">
                    <div class="container">
                        ...
                        <div class="inner-right">
                            <p>
                                Copyright © 20122 ShopMecho.&nbsp;<a href="">Privacy Policy</a>
                            </p>
                            <p>
                                <a class="ct-u-motive-color" href="" target="_blank">Web Design</a> by  <a href="www.demlinks.tech" target="_blank">Demlinks Technologies</a>
                            </p>
                        </div>
                    </div>
                </div>
